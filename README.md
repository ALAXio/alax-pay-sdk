...
Then, add the SDK library as a dependency (`implementation com.github.alaxio:alax-pay-sdk:0.1.1`) and ensure that the following dependencies, required by ALAX Pay SDK are added to the build.gradle file of the application you are working on.

```
dependencies {
    // ...
    implementation 'com.github.alaxio:alax-pay-sdk:0.1.1'
    // ...
}
```
